...
public class SucursalBO {
    ...
    public String getSucur_des() {
        return sucur_des;
    }

    public void setSucur_des(String sucur_des) {
        this.sucur_des = sucur_des;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 71 * hash + Objects.hashCode(this.co_sucur);
        hash = 71 * hash + Objects.hashCode(this.sucur_des);
    ...
    public boolean equals(Object obj) {
        ...
        final SucursalBO other = (SucursalBO) obj;
        if (!Objects.equals(this.co_sucur, other.co_sucur)) {
            return false;
        }
        if (!Objects.equals(this.sucur_des, other.sucur_des)) {
            return false;
        }
