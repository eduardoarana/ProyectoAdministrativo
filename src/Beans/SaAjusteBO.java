...
public class SaAjusteBO {
    ...
    public String getSeriales_e() {
        return seriales_e;
    }

    public void setSeriales_e(String seriales_e) {
        this.seriales_e = seriales_e;
    }
