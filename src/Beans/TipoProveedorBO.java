...
private String rowguid;
    ...
    public TipoProveedorBO() {
    }

    public TipoProveedorBO(String tip_pro, String des_tipo, String campo1, String campo2, String campo3, String campo4, String campo5, String campo6, String campo7, String campo8, String co_us_in, String co_sucu_in, String fe_us_in, String co_us_mo, String co_sucu_mo, String fe_us_mo, String revisado, String trasnfe, String validador, String rowguid) {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 59 * hash + Objects.hashCode(this.tip_pro);
        hash = 59 * hash + Objects.hashCode(this.des_tipo);
        hash = 59 * hash + Objects.hashCode(this.campo1);
        hash = 59 * hash + Objects.hashCode(this.campo2);
        hash = 59 * hash + Objects.hashCode(this.campo3);
        hash = 59 * hash + Objects.hashCode(this.campo4);
        hash = 59 * hash + Objects.hashCode(this.campo5);
        hash = 59 * hash + Objects.hashCode(this.campo6);
        hash = 59 * hash + Objects.hashCode(this.campo7);
        hash = 59 * hash + Objects.hashCode(this.campo8);
        hash = 59 * hash + Objects.hashCode(this.co_us_in);
        hash = 59 * hash + Objects.hashCode(this.co_sucu_in);
        hash = 59 * hash + Objects.hashCode(this.fe_us_in);
        hash = 59 * hash + Objects.hashCode(this.co_us_mo);
        hash = 59 * hash + Objects.hashCode(this.co_sucu_mo);
        hash = 59 * hash + Objects.hashCode(this.fe_us_mo);
        hash = 59 * hash + Objects.hashCode(this.revisado);
        hash = 59 * hash + Objects.hashCode(this.trasnfe);
        hash = 59 * hash + Objects.hashCode(this.validador);
        hash = 59 * hash + Objects.hashCode(this.rowguid);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final TipoProveedorBO other = (TipoProveedorBO) obj;
