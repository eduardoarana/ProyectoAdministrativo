...
public class TransporteBO {
    ...
    public TransporteBO(String co_tran, String des_tran, String resp_tra, String numcom, String feccom, String dis_cen, String campo1, String campo2, String campo3, String campo4, String campo5, String campo6, String campo7, String campo8, String co_us_in, String co_sucu_in, String fe_us_in, String co_us_mo, String fe_us_mo, String revisado, String trasnfe, String validador, String rowguid) {
        this.co_tran = co_tran;
        this.des_tran = des_tran;
        this.resp_tra = resp_tra;
        this.numcom = numcom;
        this.feccom = feccom;
    ...
    public String getDes_tran() {
        return des_tran;
    }

    public void setDes_tran(String des_tran) {
        this.des_tran = des_tran;
    }

    public String getResp_tra() {
        return resp_tra;
    }

    public void setResp_tra(String resp_tra) {
        this.resp_tra = resp_tra;
    }
