...
public class UnidadBO {
    ...
    public UnidadBO(String co_uni, String des_uni, String campo1, String campo2, String campo3, String campo4, String campo5, String campo6, String campo7, String campo8, String co_us_in, String co_sucu_in, String fe_us_in, String co_us_mo, String co_sucu_mo, String fe_us_mo, String revisado, String trasnfe, String validador) {
        this.co_uni = co_uni;
    ...
    public boolean equals(Object obj) {
        ...
        final UnidadBO other = (UnidadBO) obj;
        if (!Objects.equals(this.co_uni, other.co_uni)) {
            return false;
        }
        if (!Objects.equals(this.des_uni, other.des_uni)) {
            return false;
        }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.co_uni);
        hash = 59 * hash + Objects.hashCode(this.des_uni);
