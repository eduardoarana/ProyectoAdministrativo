...
public class TipoAjusteBO {
    ...
    public TipoAjusteBO(String co_tipo, String des_tipo, String tipo_trans, String campo1, String campo2, String campo3, String campo4, String campo5, String campo6, String campo7, String campo8, String co_us_in, String co_sucu_in, String fe_us_in, String co_us_mo, String co_sucu_mo, String fe_us_mo, String revisado, String trasnfe, String validador, String rowguid) {
    ...
    public boolean equals(Object obj) {
        ...
        final TipoAjusteBO other = (TipoAjusteBO) obj;
        if (!Objects.equals(this.co_tipo, other.co_tipo)) {
            return false;
        }
        if (!Objects.equals(this.des_tipo, other.des_tipo)) {
            return false;
        }
        if (!Objects.equals(this.tipo_trans, other.tipo_trans)) {
            return false;
        }
    ...
    public int hashCode() {
        int hash = 5;
        hash = 37 * hash + Objects.hashCode(this.co_tipo);
        hash = 37 * hash + Objects.hashCode(this.des_tipo);
        hash = 37 * hash + Objects.hashCode(this.tipo_trans);
        ...
        hash = 37 * hash + Objects.hashCode(this.rowguid);
        return hash;
    }
