...
public class NotaEntregaVenta {
    ...
    public String getCo_ve() {
        return co_ve;
    }

    public void setCo_ve(String co_ve) {
        this.co_ve = co_ve;
    }
    ...
    public Double getPorc_desc_glob() {
        return porc_desc_glob;
    }

    public void setPorc_desc_glob(Double porc_desc_glob) {
    ...
    public int getSeriales_s() {
        return seriales_s;
    }

    public void setSeriales_s(int seriales_s) {
