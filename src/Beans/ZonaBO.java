...
public class ZonaBO {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 23 * hash + Objects.hashCode(this.co_zon);
        hash = 23 * hash + Objects.hashCode(this.zon_des);
        hash = 23 * hash + Objects.hashCode(this.numcom);
        hash = 23 * hash + Objects.hashCode(this.feccom);
        hash = 23 * hash + Objects.hashCode(this.dis_cen);
        hash = 23 * hash + Objects.hashCode(this.campo1);
        hash = 23 * hash + Objects.hashCode(this.campo2);
        hash = 23 * hash + Objects.hashCode(this.campo3);
        hash = 23 * hash + Objects.hashCode(this.campo4);
        hash = 23 * hash + Objects.hashCode(this.campo5);
        hash = 23 * hash + Objects.hashCode(this.campo6);
        hash = 23 * hash + Objects.hashCode(this.campo7);
        hash = 23 * hash + Objects.hashCode(this.campo8);
        hash = 23 * hash + Objects.hashCode(this.co_us_in);
        hash = 23 * hash + Objects.hashCode(this.co_sucu_in);
        ...
        hash = 23 * hash + Objects.hashCode(this.trasnfe);
        hash = 23 * hash + Objects.hashCode(this.validador);
        hash = 23 * hash + Objects.hashCode(this.rowguid);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ZonaBO other = (ZonaBO) obj;
        if (!Objects.equals(this.co_zon, other.co_zon)) {
            return false;
        }
        if (!Objects.equals(this.zon_des, other.zon_des)) {
            return false;
        }
