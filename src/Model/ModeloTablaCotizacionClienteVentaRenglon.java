 ...
 * @author aranaVentur
 */
public class ModeloTablaCotizacionClienteVentaRenglon extends AbstractTableModel {

    private final String[] nombresCol;
    private final Class[] tipoColumnas;
    private ArrayList<CotizacionClienteRengBO> lista = new ArrayList<CotizacionClienteRengBO>();

    public ModeloTablaCotizacionClienteVentaRenglon() {
        ...
        this.tipoColumnas = new Class[]{Integer.class, String.class, String.class, String.class, String.class, Integer.class, Integer.class, String.class, Double.class, Double.class};
    }

    public void setlistaFacturaVentas(ArrayList<CotizacionClienteRengBO> lista) {
        this.lista = lista;
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 6:
                ...
                break;
            case 7:
                lista.get(rowIndex).setCo_precio( aValue.toString());
                break;
            case 8:
     ...
     public void addRow(CotizacionClienteRengBO facturaVentaRengBO) {
