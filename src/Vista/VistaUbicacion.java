...
public class VistaUbicacion extends javax.swing.JPanel {
    ...
    UbicacionController controller;
    UbicacionModel modelo;

    /**
     * Creates new form VistaUbicacion1
     */
    public VistaUbicacion() {
        initComponents();
        setteCampos();
        controller = new UbicacionController(this);
    ...
    public void setteCampos() {
        txtcodigoUbicacion.setText("");
        txtcodigoUbicacion.setEnabled(true);
    ...
    public void setModel() {
        try {
            jTablaUbicacion.setModel(new ModeloTablaUbicacion(modelo.listaUbicacion()));
    ...
    private void initComponents() {
        ...
        jDialogReporteUbicacion = new javax.swing.JDialog();
        ...
        jDialogUbicacion.setTitle("Busqueda Asistida");
        jDialogUbicacion.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel14.setText("Buscar :");
        jDialogUbicacion.getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 60, -1));
        ...
        jDialogUbicacion.getContentPane().add(txtBucscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 360, -1));
        ...
        jScrollPane1.setViewportView(jTablaUbicacion);

        jDialogUbicacion.getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 450, 120));
        ...
        jDialogUbicacion.getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 120, 130));
        ...
        jDialogUbicacion.getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 120, 100));
        ...
        jDialogUbicacion.getContentPane().add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 230, 100, -1));

        jLabel15.setText("Total de Registros Encontrados");
        jDialogUbicacion.getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 180, -1));

        jDialogReporteUbicacion.setTitle("Impresion de Grupo de reporte : Ubicacion");
        jDialogReporteUbicacion.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        comboReporteUbicacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ubicacion" }));
        jPanel1.add(comboReporteUbicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 230, -1));
        ...
        jDialogReporteUbicacion.getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 570, 60));
        ...
        jPanel6.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, 210, -1));

        btnDesde.setText("Desde");
        jPanel6.add(btnDesde, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 190, -1));

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Codigo :");
        jPanel6.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 50, -1));
        jPanel6.add(txtCodDesde, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 70, -1));
        jPanel6.add(txtCodHasta, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 60, -1));
        jPanel6.add(txtDescripcionHasta, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 50, 140, -1));
        jPanel6.add(txtDescripcionDesde, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 50, 110, -1));

        jDialogReporteUbicacion.getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 480, 270));

        btnAceptarImprimir.setText("Aceptar");
        btnAceptarImprimir.setToolTipText("");
        jDialogReporteUbicacion.getContentPane().add(btnAceptarImprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 80, 80, -1));

        btnCancelarImpresion.setText("Cancelar");
        jDialogReporteUbicacion.getContentPane().add(btnCancelarImpresion, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 120, 80, -1));
        ...
        add(jToolBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 50));
        ...
        txtcodigoUbicacion.setToolTipText("Codigo");
        jPanel2.add(txtcodigoUbicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, 100, -1));

        lblCodigo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCodigo.setText("Codigo :");
        jPanel2.add(lblCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 70, -1));
        jPanel2.add(txtDescripcionUbicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 250, -1));
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 33, 65, -1));

        txtCampo1.setToolTipText("campo1");
        jPanel3.add(txtCampo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 94, -1));

        jLabel3.setText("Campo2:");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(255, 33, 57, -1));

        txtcampo2.setToolTipText("Campo 2");
        jPanel3.add(txtcampo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(316, 30, 98, -1));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Campo3 :");
        jLabel5.setToolTipText("");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 79, 65, -1));

        jLabel6.setText("Campo4:");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(255, 79, 57, -1));
        jPanel3.add(txtCampo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 90, -1));
        jPanel3.add(txtcampo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 80, 90, -1));

        jTabbedPane1.addTab("Datos Adicionales", jPanel3);

        add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 630, 170));
    ...
    private void txtBucscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBucscarKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            sfieldName = (rjcodigo.isSelected()) ? "co_ubicacion" : "des_ubicacion";
            jTablaUbicacion.setModel(new ModeloTablaUbicacion(modelo.pObtenerListadoDatos(
    ...
    public javax.swing.JDialog jDialogReporteUbicacion;
    ...
    public javax.swing.JTextField txtDescripcionDesde;
    public javax.swing.JTextField txtDescripcionHasta;
    ...
    public javax.swing.JTextField txtcodigoUbicacion;
