 ...
 * @author earana
 */
public class VistaSegmento extends javax.swing.JPanel {

    /**
     * Creates new form VistaSegmento
     */
    
    SegmentoController controller;
    SegmentoModelo modelo ;
    
    public VistaSegmento() {
        initComponents();
        txtValidador.setVisible(false);
        controller= new SegmentoController(this);
      ...
      public void setModel() {
          jtablaSegmento.setModel(new ModeloTablaSegmento(modelo.pOptenerListadoDatosSegmento(
                    "admin_a", "saSegmento", "seg_des", "","0")));
      }
      
      public void setteaCampo(){
      btnGuardar.setEnabled(true);
      btnactulizar.setEnabled(false);
      btnEliminar.setEnabled(false);
      txtCampo1.setText("");
      txtCampo3.setText("");
      txtCodSegmento.setEnabled(true);
    ...
    private void initComponents() {
        ...
        jDialogSegmento = new javax.swing.JDialog();
        ...
        jDialogReporteSeg = new javax.swing.JDialog();
        ...
        txtCodSegmento = new javax.swing.JTextField();
        ...
        jDialogSegmento.setTitle("Busqueda Asistida");
        jDialogSegmento.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        txtvalorSegmento.setToolTipText("Busqueda");
        txtvalorSegmento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtvalorSegmentoKeyPressed(evt);
            }
        });
        jDialogSegmento.getContentPane().add(txtvalorSegmento, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 360, -1));

        jLabel20.setText("Buscar :");
        jDialogSegmento.getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 60, -1));
        ...
        jScrollPane3.setViewportView(jtablaSegmento);

        jDialogSegmento.getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 450, 120));
        ...
        jDialogSegmento.getContentPane().add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 120, 130));
        ...
        jDialogSegmento.getContentPane().add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 120, 100));

        btnAceptar1.setText("Aceptar");
        jDialogSegmento.getContentPane().add(btnAceptar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 98, -1));

        btnCancelar1.setText("Cancelar");
        btnCancelar1.setToolTipText("Cancelar");
        jDialogSegmento.getContentPane().add(btnCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 100, -1));

        jLabel21.setText("Total de Registros Encontrados");
        jDialogSegmento.getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 180, -1));

        jDialogReporteSeg.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        jDialogReporteSeg.getContentPane().add(jPanel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 570, 60));

        btnAceptarImprimir.setText("Aceptar");
        btnAceptarImprimir.setToolTipText("");
        jDialogReporteSeg.getContentPane().add(btnAceptarImprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 80, 80, -1));

        btnCancelarReporte.setText("Cancelar");
        jDialogReporteSeg.getContentPane().add(btnCancelarReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 120, 80, -1));
        ...
        jDialogReporteSeg.getContentPane().add(jPanelReporteDatosBasicos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 510, 270));
        ...
        txtCodSegmento.setToolTipText("Codigo Zona");
        jPanel2.add(txtCodSegmento, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 130, -1));

        lblCodigo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCodigo.setText("Codigo :");
        jPanel2.add(lblCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 100, -1));

        txtDescripcionSegmento.setToolTipText("Descripcion Zona");
        jPanel2.add(txtDescripcionSegmento, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 330, -1));
        jPanel2.add(txtValidador, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 40, 70, -1));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        jDialogSegmento.setVisible(true);
        jDialogSegmento.setSize(472, 358);
        jDialogSegmento.setLocationRelativeTo(null);
        setModel();
    }//GEN-LAST:event_btnBuscarActionPerformed

    private void txtvalorSegmentoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtvalorSegmentoKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            sfieldName = (jrCodigo1.isSelected()) ? "co_seg" : "seg_des";
            jtablaSegmento.setModel(new ModeloTablaSegmento(modelo.pOptenerListadoDatosSegmento(
                    "admin_a",
                    "saSegmento",
                    sfieldName,
                    txtvalorSegmento.getText(),
                    Opcion)
            ));
        }
    }//GEN-LAST:event_txtvalorSegmentoKeyPressed
    ...
    public javax.swing.JDialog jDialogReporteSeg;
    public javax.swing.JDialog jDialogSegmento;
    ...
    public javax.swing.JTextField txtCodSegmento;
    public javax.swing.JTextField txtDescripDesde;
    public javax.swing.JTextField txtDescripHasta;
    public javax.swing.JTextField txtDescripcionSegmento;
    public javax.swing.JTextField txtValidador;
