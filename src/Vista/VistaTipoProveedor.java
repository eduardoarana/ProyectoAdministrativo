...
import Controller.TipoProveedorController;
 ...
 * @author earana
 */
public class VistaTipoProveedor extends javax.swing.JPanel {

    /**
     * Creates new form VistaTipoProveedor
     */
    TipoProveedorModelo tipoProveedorModelo;
    TipoProveedorController controller ;

    public VistaTipoProveedor() {
        initComponents();
        tipoProveedorModelo = new TipoProveedorModelo();
        controller = new TipoProveedorController(this);
        ...
        btnAceptarImprimirTipoProbedor.addActionListener(controller);
    ...
    public void settear(){
        txtCodTipoProveedor.setEnabled(true);
        txtCodTipoProveedor.setEditable(true);
        txtCodTipoProveedor.setText("");
        txtDescripcionTipoProvee.setText("");
        txtCampo1.setText("");
        txtCampo3.setText("");
        txtcampo2.setText("");
        txtcampo4.setText("");
    ...
    public void setModel(){
     jtablaTipo.setModel(new ModeloTablaTipoProveedor(tipoProveedorModelo.pObtenerListadoDatosProveedor(
    ...
    private void initComponents() {
        ...
        JDialogoTipoProveedor = new javax.swing.JDialog();
        ...
        jDialogReporteTipoProveedor = new javax.swing.JDialog();
        ...
        btnAceptarImprimirTipoProbedor = new javax.swing.JButton();
        ...
        txtCodTipoProveedor = new javax.swing.JTextField();
        lblCodigo = new javax.swing.JLabel();
        txtDescripcionTipoProvee = new javax.swing.JTextField();
        ...
        JDialogoTipoProveedor.setTitle("Busqueda Asistida");
        JDialogoTipoProveedor.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel20.setText("Buscar :");
        JDialogoTipoProveedor.getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 60, -1));
        ...
        JDialogoTipoProveedor.getContentPane().add(txtvalor, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 360, -1));
        ...
        JDialogoTipoProveedor.getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 450, 120));
        ...
        JDialogoTipoProveedor.getContentPane().add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 120, 130));
        ...
        JDialogoTipoProveedor.getContentPane().add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 120, 100));

        btnAceptar1.setText("Aceptar");
        JDialogoTipoProveedor.getContentPane().add(btnAceptar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 98, -1));

        btnCancelar1.setText("Cancelar");
        btnCancelar1.setToolTipText("Cancelar");
        JDialogoTipoProveedor.getContentPane().add(btnCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 100, -1));

        jLabel21.setText("Total de Registros Encontrados");
        JDialogoTipoProveedor.getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 180, -1));

        jDialogReporteTipoProveedor.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel26.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jPanel26.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        comboReporteZona.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tipo de Proveedor" }));
        ...
        jDialogReporteTipoProveedor.getContentPane().add(jPanel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 570, 60));
        ...
        jDialogReporteTipoProveedor.getContentPane().add(jPanelReporteDatosBasicos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 500, 250));

        btnCancelarReporte.setText("Cancelar");
        jDialogReporteTipoProveedor.getContentPane().add(btnCancelarReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 120, 80, -1));

        btnAceptarImprimirTipoProbedor.setText("Aceptar");
        btnAceptarImprimirTipoProbedor.setToolTipText("");
        jDialogReporteTipoProveedor.getContentPane().add(btnAceptarImprimirTipoProbedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 80, 80, -1));
        ...
        txtCodTipoProveedor.setToolTipText("Codigo Color");
        jPanel2.add(txtCodTipoProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 130, -1));

        lblCodigo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCodigo.setText("Codigo :");
        jPanel2.add(lblCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 100, -1));

        txtDescripcionTipoProvee.setToolTipText("Descripcion Color");
        jPanel2.add(txtDescripcionTipoProvee, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 330, -1));
        ...
        add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 680, 210));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        txtCodTipoProveedor.setEditable(false);
        btnEliminar.setEnabled(true);
        btnactulizar.setEnabled(true);
        JDialogoTipoProveedor.setVisible(true);
        JDialogoTipoProveedor.setSize(472,358);
        JDialogoTipoProveedor.setLocationRelativeTo(null);
        setModel();
    ...
    private void txtvalorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtvalorKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            sfieldName = (jrCodigo1.isSelected()) ? "tip_pro" : "des_tipo";
            jtablaTipo.setModel(new ModeloTablaTipoProveedor(tipoProveedorModelo.pObtenerListadoDatosProveedor(
                    Vistaprincipal.tempEmpresa,
                 "saTipoProveedor",
                 sfieldName,
    ...
    public javax.swing.JDialog JDialogoTipoProveedor;
    public javax.swing.JButton btnAceptar1;
    public javax.swing.JButton btnAceptarImprimirTipoProbedor;
    ...
    public javax.swing.JDialog jDialogReporteTipoProveedor;
    ...
    public javax.swing.JTextField txtCodTipoProveedor;
    public javax.swing.JTextField txtDescripDesde;
    public javax.swing.JTextField txtDescripHasta;
    public javax.swing.JTextField txtDescripcionTipoProvee;
